...
#### Template for ggplot components (skeleton of ggplot call)
...
ggplot(data=d) +
  aes(x=hwy) +
  geom_histogram(fill="lightsteelblue",color="black")

# Treating the khaki and the black as attributes of the histogram rather than attributes of the data 
...
ggplot(data=d) +
  ...
  geom_point() +
  geom_smooth() +
  geom_smooth(method="lm",col="plum")
