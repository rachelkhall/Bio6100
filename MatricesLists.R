...
myList[4]
myList[4] - 3 
# no, can't subtract a number from a list! Nonnumeric argument to a binary operator error 
...
myList[[2]]
myList[[2]][4,1] 
# just getting the fourth row, first column value 
...
str(summary(myModel))
summary(myModel)$coefficients # will just give the coefficients we want 
summary(myModel)$coefficients["xVar","Pr(>|t|)"] #further pulls out 
